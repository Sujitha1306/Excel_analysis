...
- Name: validation.spec.ts >> Validation Dashboard E2E >> Test 2: Click Critical issue -> detail panel opens -> cross-sheet comparison renders
- Location: tests/e2e/validation.spec.ts:97:7
