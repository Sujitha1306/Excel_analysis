...
- Name: validation.spec.ts >> Validation Dashboard E2E >> Test 8: AI API unavailable (mock) -> banner shown, rule-based results still display
- Location: tests/e2e/validation.spec.ts:189:7
...
Locator: getByText('Validation Audit')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Validation Audit')
