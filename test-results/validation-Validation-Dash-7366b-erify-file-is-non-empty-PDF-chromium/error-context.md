...
- Name: validation.spec.ts >> Validation Dashboard E2E >> Test 5: Download PDF report -> file downloads -> verify file is non-empty PDF
- Location: tests/e2e/validation.spec.ts:149:7
